...
public class StartWindow extends javax.swing.JFrame {
    ...
    private void jButtonSelInputDirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelInputDirActionPerformed
        ...
        //warning - untested!
        Collection<File> newList = guiHelper.getFileList(jTextFieldInputDir.getText(),jTextFieldRegEx.getText());
        jListFileList.setListData(newList.toArray(new String[newList.size()]));
